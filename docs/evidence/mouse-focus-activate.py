#!/usr/bin/env python3
"""Local mouse focus correction: immutable release and guarded restoration of configuration files."""
...
def complete_switch():
    ...
    panels = {}
    for target, method in [('ui', 'openAudio'), ('launcher', 'openCommands'), ('launcher', 'openClipboard'), ('ui', 'openQuickSettings')]:
