#!/usr/bin/env python3
"""Local audio panel and launcher shortcuts: immutable release and guarded restoration of configuration files."""
...
def complete_switch():
    ...
    selected_binds = []
    for mask, key, description in [(64, 'space', 'Launcher'), (64, 'v', 'Schowek'), (65, 'semicolon', 'Komendy')]:
    ...
    result = {'panel_ipc': panels, 'audio_toggle': True, 'audio_before': before_audio, 'audio_after': after_audio,
