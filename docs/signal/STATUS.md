...
main `311edb8` oraz jego 118 dodatkowych plików dowodów. Wszystkie 357
plików kodu runtime są identyczne z działającym wydaniem
`20260921-110638-03f24e35e2b4`. Ponowna bramka: 272 QML bez błędów.
Dotychczasowe 32 celowane testy Qt i natywny Wayland dotyczą identycznego
kodu; bez ponownego wdrożenia. Zachowano gałąź signal oraz rozszerzoną
macierz live. [Dowód scalenia](../evidence/signal/S12/merge-main.json).
...
Bieżące źródła są na `main` w `/home/attntd/projects/putkin`.
Worktree `/home/attntd/projects/signal` zachowuje gałąź `signal` z commitem
integracji; jej bazą był `f16840763eb030efea9eb21585c3b7b9aa5e8bc6`.
Są to checkouty źródeł, nie katalogi opublikowanego shella.
